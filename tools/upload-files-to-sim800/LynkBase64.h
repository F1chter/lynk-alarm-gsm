...
void fromA3ToA4(unsigned char *A4, const unsigned char *A3);
void fromA4ToA3(unsigned char *A3, const unsigned char *A4);
unsigned char lookupTable(char c);

int encodeToBase64(char *output, const char *input, int inputLength) {
	int i = 0, j = 0;
	int encodedLength = 0;
	unsigned char A3[3];
	unsigned char A4[4];
...
int decodeFromBase64(char *output, const char *input, int inputLength) {
	int i = 0, j = 0;
	int decodedLength = 0;
	unsigned char A3[3];
	unsigned char A4[4];
